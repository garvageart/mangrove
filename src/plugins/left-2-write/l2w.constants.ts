...
import { constructServiceURLs } from "./l2w.util";

export const L2W_EDITING_SERVER_PORT = 7777;
export const L2W_EDITING_SERVER_URL = constructServiceURLs('http://leaf-live-editor.lesis.online');
export const L2W_EDITING_SERVER_HREF = `${L2W_EDITING_SERVER_URL}:${L2W_EDITING_SERVER_PORT}`;

export const L2W_SERVER_PORT = 3333;
export const L2W_SERVER_URL = constructServiceURLs('http://leaf.lesis.online');
export const L2W_SERVER_HREF = (IS_ENV.production || process) && (!globalThis.window) ? `http://127.0.0.1:${L2W_SERVER_PORT}` : `${L2W_SERVER_URL}:${L2W_SERVER_PORT}`;

export const L2W_EDITOR_PORT = 5555;
export const L2W_EDITOR_URL = constructServiceURLs('http://leaf-editor.lesis.online');
